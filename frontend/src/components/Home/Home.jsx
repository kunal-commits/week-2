...
export const songs = [
  {
    ...
    id: 1,
    title: "Kastoori",
    img: "/assets/kasturi.jpg",
    artist: "Prasad S, Arijit Singh",
    mp3: new Audio("/assets/kasturi.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 2,
    title: "Morni",
    img: "/assets/morni.jpg",
    artist: "Badshah, Sharvi Yadav, Hiten",
    mp3: new Audio("/assets/Morni.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 3,
    title: "Aayi Nayi Stree 2",
    img: "/assets/aayi_nahi.jpg",
    artist: "Pawan Singh, Divya Kumar, Simran Choud , Amitabh Bhattacharya, Sachin Jigar",
    mp3: new Audio("/assets/Aayi_Nahi.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 4,
    title: "Sanam Teri Kasam",
    img: "/assets/sanam-teri-kasam.jpg",
    artist: "Ankit Tiwari, Palak Muchhal , Himesh Reshammiya",
    mp3: new Audio("/assets/sanam_teri_kasam.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 5,
    title: "Desires - AP Dhillon",
    img: "/assets/desires.jpg",
    artist: "Ap Dhillon, SHINDA KAHLON, GURINDER GILL",
    mp3: new Audio("/assets/desires.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 6,
    title: "Rooh",
    img: "/assets/rooh1.jpg",
    artist: "Yo Yo Honey Singh, Hritu Zee",
    mp3: new Audio("/assets/rooh.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 7,
    title: "Moonlight Harnoor",
    img: "/assets/moonlight.jpg",
    artist: "Harnoor, MXRCI, Ilam",
    mp3: new Audio("/assets/Moonlight.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 8,
    title: "Kaho Na Kaho",
    img: "/assets/kaho_na.jpg",
    artist: "Amir Jamal, Anu Malik",
    mp3: new Audio("/assets/kaho_na_kaho.mp3")
  },
  {
    // id: Math.random() * Date.now(),
    id: 9,
    title: "Pushpa 2",
    img: "/assets/pushpa2.png",
    artist: "Devi Sri Prasad",
    mp3: new Audio("/assets/pushpa2s.mp3")
  },
]
